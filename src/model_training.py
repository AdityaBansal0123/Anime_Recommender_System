...
class ModelTraining:
    def __init__(self,data_path):
        ...
        self.experiment = comet_ml.Experiment(
            api_key="ukzsAfDCovBS2dZsrku1xavJf",
            project_name="mlops-course-2",
            workspace="adityabansal0123"
        )
    ...
    def load_data(self):
        try:
            ...
            y_train_array = joblib.load(Y_TRAIN)
            y_test_array = joblib.load(Y_TEST)
    ...
    def train_model(self):
        try:
            ...
            n_anime = len(joblib.load(ANIM2ANIME_ENCODED))
            ...
            raise CustomException("Error in preparing data for training",e)
