...
class BaseModel:
    def __init__(self,config_path):
        try:
            ...
            raise CustomException("Error loading Configuration file",e)
    ...
    def RecommenderNet(self,n_users,n_anime):
        try:
            ...
            logger.error(f'Error in building RecommenderNet model {e}')
            raise CustomException("Error in building RecommenderNet model",e)
